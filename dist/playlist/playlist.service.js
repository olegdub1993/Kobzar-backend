...
let PlaylistService = class PlaylistService {
    ...
    async create(userId, dto, picture) {
        ...
        const playlist = await this.playlistModel.create(Object.assign(Object.assign({}, dto), { picture: picturePath, likes: 0, userId, userPicture: user.picture }));
    ...
    async updateUserDataForPlaylist(arrayOfId, username, userPicturePath) {
        ...
        playlists.forEach(async (playlist) => {
            ...
            if (userPicturePath) {
                playlist.userPicture = userPicturePath;
            }
            await playlist.save();
        });
    }
